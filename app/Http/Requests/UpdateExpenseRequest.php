...
class UpdateExpenseRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'fonte_id' => 'sometimes|required|exists:categories,id',
            'bloco_id' => 'sometimes|required|exists:categories,id',
            'grupo_id' => 'sometimes|required|exists:categories,id',
            'acao_id' => 'sometimes|required|exists:categories,id',
            'expense_classification_id' => 'sometimes|required|exists:expense_classifications,id',
    ...
    public function messages(): array
    {
        return [
            ...
            'expense_classification_id.required' => 'A classificação de despesa é obrigatória.',
            'expense_classification_id.exists' => 'A classificação selecionada não existe.',
