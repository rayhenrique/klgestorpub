...
return [
    ...
    */
    ...
    'name' => env('APP_NAME', 'KL Gestor Pub'),
    ...
    |--------------------------------------------------------------------------
    |
    | This value is the version of your application. This will be used when the
    | framework needs to display the application version in notifications or
